    ...
    return (
        <AboutSection id="aboutme">
            <Container>
                <AboutSectionContent>
                    <AboutSectionText>
                        <h2>Passionate about technology since forever, I have discovered my new career path in programming. 
                            ...
                            pursue my passion for technology and embark on an exciting career in programming.</h2>
                    </AboutSectionText>
                </AboutSectionContent>
            </Container>
        </AboutSection>
